...
impl TrezorSigner {
    ...
    async fn sign_typed_data_inner(
        ...
        // The resolver doesn't include EIP712Domain — build it from
        // whichever domain fields are actually set so the Trezor can
        // compute the correct domain separator hash on-device.
